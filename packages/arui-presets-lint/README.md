...
При установке или обновлении `arui-presets-lint` автоматически создаёт (или обновляет) файл `AGENTS.md` в корне вашего проекта. В него добавляется краткий блок с ключевыми правилами линтеров на английском языке, чтобы AI-ассистенты (Kilo Code, Opencode и т.п.), которые читают `AGENTS.md`, сразу писали код по принятым в компании стандартам и не нарушали правила ESLint / Stylelint / Prettier.
