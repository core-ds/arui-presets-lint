...
/** Только ASCII в идентификаторах для JS (правила TS — в typescriptConfig). */
const asciiIdMatchRule: Linter.RuleEntry = [
    'error',
...
export const variablesConfig: Linter.Config[] = [
    ...
    {
        name: 'arui-presets-lint/variables/ascii-identifiers-javascript',
        files: ['**/*.{js,jsx,mjs,cjs,mjsx}'],
        rules: {
            'id-match': asciiIdMatchRule,
        },
    },
];
