...
export default {
    ...
    ignoreDependencies: [
        ...
        '@types/webpack-env',
        '@types/css-modules',
        // Пресет передаётся строкой в конфигурацию arui-scripts и резолвится в рантайме,
        // поэтому knip не видит его как используемую зависимость
        'arui-scripts-corporate-presets',
    ],
